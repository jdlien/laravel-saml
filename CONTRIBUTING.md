...
This package is a Laravel binding around the [SAML-Toolkits PHP toolkit](https://github.com/SAML-Toolkits/php-saml) — protocol-level SAML logic belongs upstream there, not here.
